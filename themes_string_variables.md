The Blueprint theme uses the following LNG variables to reference text strings. This list is sorted alphabetically by variable name. To make it easier for store owners who may wish to translate or otherwise modify their strings, use these variables instead of hardcoding string values into your theme.
